...
import { HiArrowSmallLeft, HiMiniLockClosed } from "react-icons/hi2";
...
import passwordImage from "../assets/images/newPassword.png";
...
function newPassword() {
  ...
  return (
    <div className="relative w-screen h-screen">
      <BackgroundBubbles background="newPassword" />
        ...
        <TransparentCenter className="md:w-[600px]">
          ...
          >
            <img
              ...
              src={passwordImage}
              alt="Register Disney"
              className="flex items-center justify-center pointer-events-none select-none w-52 md:w-72"
            />
          </div>
          {!isSubmitted ? (
            ...
            <div className="flex flex-col items-center justify-center mt-2">
              <div className="h-10 w-10 md:h-12 md:w-12 bg-emerald-700 rounded-full flex items-center justify-center mx-auto mb-4 relative">
                <HiMiniLockClosed className="h-6 w-6 md:h-8 md:w-8 text-gray-300" />
